                    ...
                    <table border="1">
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <button type="button" id="btnCheckUid"><img src="/jboard/images/chk_id.gif" alt=""></button>
                    ...
                    <table border="1">
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <button type="button" id="btnSendEmail" ><img src="/jboard/images/chk_auth.gif" alt="인증번호 받기"/></button>
                                <span class="resultEmail"></span>
                                <div class="auth">
                                    <input type="text" name="auth" placeholder="인증번호 입력"/>
                                    <button type="button" id="btnAuthEmail"><img src="/jboard/images/chk_confirm.gif" alt="확인"/></button>
                                </div>
                            </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td>
                                <div>
                                    ...
                                    <button type="button" onclick="postcode()"><img src="/jboard/images/chk_post.gif" alt=""></button>
                                </div>                            
                                <div>
